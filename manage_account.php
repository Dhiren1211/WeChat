...
<div class="col-md-8 offset-2">
    <div class="card shadow-lg">
        <div class="card-header rounded-0 bg-light">
            <div class="card-title flex">Manage Account Information & Credentials
            <a href="./?page=profile">
                 <button style ='margin-top:0%; margin-bottom:0%; margin-left:90%; border:none; height:30px; width:30px; background-color:red; color:white;'><span><i class="fa fa-multiply"></i></span></button>
             </a>  
            </div>
           <center> <small class="text-dark"><i> <b> Note: Only fill password and confirm password fields when you want to change your password!!</b></i></small></center>
        </div>
...
<script>
    ...
    $('#update-account').submit(function(e){
        ...
        formData.append('id', $('<?php echo $_SESSION['id']?>').val()); // Adjust the selector based on your HTML structure

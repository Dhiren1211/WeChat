...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> |WeChat</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark bg-gradient" id="topNavBar">
            <div class="container">
                <a class="navbar-brand" href="./">
                    <i class="fa-regular fa-message"></i> <i><b>WeChat</b></i>
                </a>
                ...
                <div>
                    ...
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle bg-transparent text-light border-0"
                            ...
                            <span class="me-1"><img
                                    src="<?php echo $_SESSION['image_link'] ?>"style = "height:60px; width:50px;" alt="./images/no-image-available.png"
                                    class="avatar rounded-circle">&nbsp;</span> <i> <?php echo $_SESSION['firstname']." ".$_SESSION['lastname'] ?></i>
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><a class="dropdown-item" href="./?page=profile" style = "color:black;"><i>My Profile</i></a></li>
                            <li><a class="dropdown-item" href="./Actions.php?a=logout" style = "color:black;"><i>Logout</i></a></li>
                        </ul>
                    </div>
                    <?php endif; ?>
                </div>
